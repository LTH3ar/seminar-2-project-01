...
\textbf{The published baseline} is the competition's SetFit result, which is what ``how good is this?'' ultimately means in Table~\ref{tab:published_baseline_scores}
