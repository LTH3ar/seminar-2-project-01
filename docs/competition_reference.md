...
The process of extracting the dataset is described in the [dataset notebook](../notebooks/00_dataset_extraction_reference.ipynb).
...
### [SetFit](../notebooks/02_setfit_baseline.ipynb)
